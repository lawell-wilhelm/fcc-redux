...
you should get a similar output in the terminal and package.json

Our Redux development environment is set. We can now follow along FCC's Redux section
...
4. follow the instruction in the above link and create the action creator
